...
window.JSON&&window.JSON.stringify||function(){function a(){try{return this.valueOf()}catch(a){return t}}function c(a){d.lastIndex=0;return d.test(a)?'"'+a.replace(d,function(a){var b=H[a];return"string"===typeof b?b:"\\u"+("0000"+a.charCodeAt(0).toString(16)).slice(-4)})+'"':'"'+a+'"'}function b(d,f){var q,h,r,p,i,k=e,g=f[d];g&&"object"===typeof g&&(g=a.call(g));"function"===typeof m&&(g=m.call(f,d,g));switch(typeof g){case "string":return c(g);case "number":return isFinite(g)?String(g):"null";case "boolean":case "null":return String(g);
case "object":if(!g)return"null";e+=s;i=[];if("[object Array]"===Object.prototype.toString.apply(g)){p=g.length;for(q=0;q<p;q+=1)i[q]=b(q,g)||"null";r=0===i.length?"[]":e?"[\n"+e+i.join(",\n"+e)+"\n"+k+"]":"["+i.join(",")+"]";e=k;return r}if(m&&"object"===typeof m){p=m.length;for(q=0;q<p;q+=1)h=m[q],"string"===typeof h&&(r=b(h,g))&&i.push(c(h)+(e?": ":":")+r)}else for(h in g)Object.hasOwnProperty.call(g,h)&&(r=b(h,g))&&i.push(c(h)+(e?": ":":")+r);r=0===i.length?"{}":e?"{\n"+e+i.join(",\n"+e)+"\n"+
k+"}":"{"+i.join(",")+"}";e=k;return r}}window.JSON||(window.JSON={});var d=/[\\\"\x00-\x1f\x7f-\x9f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g,e,s,H={"\b":"\\b","\t":"\\t","\n":"\\n","\f":"\\f","\r":"\\r",'"':'\\"',"\\":"\\\\"},m;"function"!==typeof JSON.stringify&&(JSON.stringify=function(a,c,d){var h;s=e="";if("number"===typeof d)for(h=0;h<d;h+=1)s+=" ";else"string"===typeof d&&(s=d);if((m=c)&&"function"!==typeof c&&("object"!==typeof c||"number"!==
...
(M=1,g.onerror=t,clearTimeout(ea),a||!b||N(b),setTimeout(function(){a&&O();var b=ta(E),c=b&&b.parentNode;c&&c.removeChild(b)},I))}if(Ca||W()){a:{var b,d,e=function(){if(!H){H=1;clearTimeout(L);try{d=JSON.parse(b.responseText)}catch(a){return p(1)}s=1;h(d)}},s=0,H=0,m=a.timeout||1E4,L=setTimeout(function(){p(1)},m),f=a.b||x(),q=a.data||{},h=a.c||x(),r="undefined"===typeof a.g,p=function(a,c){s||(s=1,clearTimeout(L),b&&(b.onerror=b.onload=t,b.abort&&b.abort(),b=t),a&&f(c))};try{b=W()||window.XDomainRequest&&
new XDomainRequest||new XMLHttpRequest;b.onerror=b.onabort=function(){p(1,b.responseText||{error:"Network Connection Error"})};b.onload=b.onloadend=e;b.onreadystatechange=function(){if(b&&4==b.readyState)switch(b.status){case 401:case 402:case 403:try{d=JSON.parse(b.responseText),p(1,d)}catch(a){return p(1,b.responseText)}}};r&&(b.timeout=m);q.pnsdk=Ea;var i=ka(a.url,q);b.open("GET",i,r);b.send()}catch(k){p(0);Ca=0;a=Fa(a);break a}a=p}return a}var g=Ba("script"),e=a.a,E=ga(),M=0,ea=setTimeout(function(){c(1)},
...
Y.list[a]||[]).push(c)},fire:function(a,c){Q(Y.list[a]||[],function(a){a(c)})}},Z=ta("pubnub")||0,La=function(a){function c(){}function b(a,b){function c(b){b&&(ia=J()-(b/1E4+(J()-d)/2),a&&a(ia))}var d=J();b&&c(b)||z.time(c)}function d(a,b){R&&R(a,b);R=t}function e(){z.time(function(a){b(x(),a);a||d(1,{error:"Heartbeat failed to connect to Pubnub Servers.Please check your network settings."});setTimeout(e,r)})}function s(){Na()||d(1,{error:"Offline. Please check your network settings. "});setTimeout(s,
I)}function H(a){var b=0;Q(qa(F),function(c){if(c=F[c])b++,(a||x())(c)});return b}function m(a){if(Oa){if(!y.length)return}else{a&&(y.h=0);if(y.h||!y.length)return;y.h=1}A(y.shift())}a.jsonp&&(Ca=0);var L=a.subscribe_key||"";a.uuid||Ja.get(L+"uuid");a.xdr=Fa;a.db=Ja;a.error=ua;a._is_online=Ha;a.jsonp_cb=Da;a.PNSDK=Ea;a.hmac_SHA256=sa;var f,q=+a.windowing||10,h=(+a.timeout||310)*I,r=(+a.keepalive||60)*I,p=a.noleave||0,i=a.publish_key||"demo",k=a.subscribe_key||"demo",g=a.auth_key||"",E=a.secret_key||
"",M=a.PNSDK||"",ea=a.hmac_SHA256,O=a.ssl?"s":"",N="http"+O+"://"+(a.origin||"pubsub.pubnub.com"),K=P(N),wa=P(N),y=[],ia=0,za=0,Aa=0,R=0,ma=0,S=0,F={},Oa=a.no_wait_for_pending,A=a.xdr,l=a.error||x(),Na=a._is_online||function(){return 1},G=a.jsonp_cb||function(){return 0},T=a.db||{get:x(),set:x()},B=a.uuid||T&&T.get(k+"uuid")||"",z={LEAVE:function(a,b,c,d){var X={uuid:B,auth:g},e=P(N),c=c||x(),v=d||x(),d=G();if(0<a.indexOf(D))return j;if(p||!O||"0"==d)return u;"0"!=d&&(X.callback=d);A({g:b||O,timeout:2E3,
a:d,data:X,c:function(a){"object"==typeof a&&a.error?v(a):c(a)},b:v,url:[e,"v2","presence","sub_key",k,"channel",encodeURIComponent(a),"leave"]});return j},history:function(a,b){var b=a.callback||b,c=a.count||a.limit||100,d=a.reverse||"false",X=a.error||x(),e=a.auth_key||g,v=a.channel,w=a.start,f=a.end,i={},n=G();if(!v)return l("Missing Channel");if(!b)return l("Missing Callback");if(!k)return l("Missing Subscribe Key");i.stringtoken="true";i.count=c;i.reverse=d;i.auth=e;n&&(i.callback=n);w&&(i.start=
w);f&&(i.end=f);A({a:n,data:i,c:function(a){"object"==typeof a&&a.error?X(a):b(a)},b:X,url:[K,"v2","history","sub-key",k,"channel",encodeURIComponent(v)]})},replay:function(a){var b=b||a.callback||x(),c=a.auth_key||g,d=a.source,e=a.destination,f=a.stop,v=a.start,w=a.end,Pa=a.reverse,a=a.limit,h=G(),n={};if(!d)return l("Missing Source Channel");if(!e)return l("Missing Destination Channel");if(!i)return l("Missing Publish Key");if(!k)return l("Missing Subscribe Key");"0"!=h&&(n.callback=h);f&&(n.stop=
"all");Pa&&(n.reverse="true");v&&(n.start=v);w&&(n.end=w);a&&(n.count=a);n.auth=c;A({a:h,c:function(a){"object"==typeof a&&a.error?err(a):b(a)},b:function(){b([0,"Disconnected"])},url:[K,"v1","replay",i,k,d,e],data:n})},auth:function(a){g=a;c()},time:function(a){var b=G();A({a:b,data:{uuid:B,auth:g},timeout:5*I,url:[K,"time",b],c:function(b){a(b[0])},b:function(){a(0)}})},publish:function(a,b){var b=b||a.callback||x(),c=a.message,d=a.channel,e=a.auth_key||g,f=a.error||x(),v=G(),w="push";a.prepend&&
(w="unshift");if(!c)return l("Missing Message");if(!d)return l("Missing Channel");if(!i)return l("Missing Publish Key");if(!k)return l("Missing Subscribe Key");c=JSON.stringify(c);y[w]({a:v,timeout:5*I,url:[K,"publish",i,k,0,encodeURIComponent(d),v,encodeURIComponent(c)],data:{uuid:B,auth:e},b:function(a){f(a);m(1)},c:function(a){"object"==typeof a&&a.error?f(a):b(a);m(1)}});m()},unsubscribe:function(a,b){var d=a.channel,b=b||a.callback||x(),e=a.error||x();S=0;ma=1;d=pa((d.join?d.join(","):""+d).split(","),
function(a){if(F[a])return a+","+a+D}).join(",");Q(d.split(","),function(a){var c=j;a&&(C&&(c=z.LEAVE(a,0,b,e)),c||b({action:"leave"}),F[a]=0)});c()},subscribe:function(a,b){function e(a){a?setTimeout(c,I):(K=P(N,1),wa=P(N,1),setTimeout(function(){z.time(e)},I));H(function(b){if(a&&b.d)return b.d=0,b.m(b.name);!a&&!b.d&&(b.d=1,b.l(b.name))})}function i(){var a=G(),b=qa(F).join(",");b&&(d(),R=A({timeout:O,a:a,b:function(a){p(a);R=t;z.time(e)},data:{uuid:B,auth:m},url:[wa,"subscribe",k,encodeURIComponent(b),
a,S],c:function(a){R=t;if(!a||"object"==typeof a&&"error"in a&&a.error)return p(a),setTimeout(c,I);n(a[1]);S=!S&&ma&&T.get(k)||a[1];H(function(a){a.f||(a.f=1,a.k(a.name))});y&&(S=1E4,y=0);T.set(k,a[1]);var b,d=(2<a.length?a[2]:pa(F,function(b){return pa(Array(a[0].length).join(",").split(","),function(){return b})}).join(",")).split(",");b=function(){var a=d.shift()||Aa;return[(F[a]||{}).a||za,a.split(D)[0]]};var e=J()-ia-+a[1]/1E4;Q(a[0],function(c){var d=b();d[0](c,a,d[1],e)});setTimeout(i,L)}}))}
var f=a.channel,b=(b=b||a.callback)||a.message,m=a.auth_key||g,v=a.connect||x(),w=a.reconnect||x(),r=a.disconnect||x(),p=a.error||x(),n=a.idle||x(),s=a.presence||0,E=a.noheresync||0,y=a.backfill||0,M=a.timetoken||0,O=a.timeout||h,L=a.windowing||q;ma=a.restore;S=M;if(!f)return l("Missing Channel");if(!b)return l("Missing Callback");if(!k)return l("Missing Subscribe Key");Q((f.join?f.join(","):""+f).split(","),function(a){var c=F[a]||{};F[Aa=a]={name:a,f:c.f,d:c.d,j:1,a:za=b,k:v,l:r,m:w};s&&(z.subscribe({channel:a+
D,callback:s}),!c.j&&!E&&z.here_now({channel:a,callback:function(b){Q("uuids"in b?b.uuids:[],function(c){s({action:"join",uuid:c,timestamp:J(),occupancy:b.occupancy||1},b,a)})}}))});c=function(){d();setTimeout(i,L)};if(!C)return ba.push(c);c()},here_now:function(a,b){var b=a.callback||b,c=a.error||x(),d=a.auth_key||g,e=a.channel,f=G(),d={uuid:B,auth:d};if(!e)return l("Missing Channel");if(!b)return l("Missing Callback");if(!k)return l("Missing Subscribe Key");"0"!=f&&(d.callback=f);A({a:f,data:d,
c:function(a){"object"==typeof a&&a.error?c(a):b(a)},b:c,url:[K,"v2","presence","sub_key",k,"channel",encodeURIComponent(e)]})},grant:function(a,b){var b=a.callback||b,c=a.error||x(),d=a.channel,e=G(),f=a.ttl||-1,g=a.read?"1":"0",w=a.write?"1":"0",h=a.auth_key;if(!d)return l("Missing Channel");if(!b)return l("Missing Callback");if(!k)return l("Missing Subscribe Key");if(!i)return l("Missing Publish Key");if(!E)return l("Missing Secret Key");var m=Math.floor((new Date).getTime()/1E3),n=ea(k+"\n"+i+
"\ngrant\n"+(h&&0<encodeURIComponent(h).length?"auth="+encodeURIComponent(h)+"&":"")+"channel="+encodeURIComponent(d)+"&pnsdk="+encodeURIComponent(M)+"&r="+g+"&timestamp="+encodeURIComponent(m)+(-1<f?"&ttl="+f:"")+"&w="+w,E),n=n.replace(/\+/g,"-"),n=n.replace(/\//g,"_"),d={w:w,r:g,signature:n,channel:encodeURIComponent(d),timestamp:m};"0"!=e&&(d.callback=e);-1<f&&(d.ttl=f);h&&(d.auth=encodeURIComponent(h));A({a:e,data:d,c:function(a){b(a)},b:c,url:[K,"v1","auth","grant","sub-key",k]})},audit:function(a,
b){var b=a.callback||b,c=a.error||x(),d=a.channel,e=a.auth_key,f=G();if(!b)return l("Missing Callback");if(!k)return l("Missing Subscribe Key");if(!i)return l("Missing Publish Key");if(!E)return l("Missing Secret Key");var g=Math.floor((new Date).getTime()/1E3),h=k+"\n"+i+"\naudit\n";e&&(h+="auth="+encodeURIComponent(e)+"&");d&&(h+="channel="+encodeURIComponent(d)+"&");h+="pnsdk="+encodeURIComponent(M)+"&timestamp="+g;h=ea(h,E);h=h.replace(/\+/g,"-");h=h.replace(/\//g,"_");g={signature:h,timestamp:g};
"0"!=f&&(g.callback=f);d&&(g.channel=encodeURIComponent(d));e&&(g.auth=encodeURIComponent(e));A({a:f,data:g,c:function(a){b(a)},b:c,url:[K,"v1","auth","audit","sub-key",k]})},revoke:function(a,b){a.read=u;a.write=u;z.grant(a,b)},set_uuid:function(a){B=a;c()},get_uuid:function(){return B},xdr:A,ready:ra,db:T,uuid:ja,map:pa,each:Q,"each-channel":H,grep:na,offline:function(){d(1)},supplant:oa,now:J,unique:ga,updater:la};B||(B=z.uuid());T.set(k+"uuid",B);setTimeout(s,I);setTimeout(e,r);b();f=z;f.css=
ya;f.$=ta;f.create=Ba;f.bind=U;f.head=xa;f.search=va;f.attr=V;f.events=Y;f.init=La;U("beforeunload",window,function(){f["each-channel"](function(a){f.LEAVE(a.name,0)});return j});if(a.notest)return f;U("offline",window,f.offline);U("offline",document,f.offline);return f};"complete"===document.readyState?setTimeout(ra,0):U("load",window,function(){setTimeout(ra,0)});var $=Z||{};PUBNUB=La({notest:1,publish_key:V($,"pub-key"),subscribe_key:V($,"sub-key"),ssl:!document.location.href.indexOf("https")||
